...
import { Share2, Download, Shield, GraduationCap, ChevronRight, CheckCircle2, TrendingUp, Award, UserCheck } from 'lucide-react';
...
// --- Flags ---
// DORM_WEEK_TAKEOVER_BACKUP_LOCKED_02_19_26
                        ...
                        {isScanning ? (
                            ...
                            <div className="w-full max-w-4xl space-y-12 text-center relative z-10">
                                ...
                                <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
                                    ...
                                    <div
                                        id="student-id-card"
                                        className="relative w-full max-w-sm aspect-[1.586] bg-black rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-white/20 group hover:scale-[1.02] transition-transform duration-500 transform rotate-1"
                                    >
