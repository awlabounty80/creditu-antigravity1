            ...
            <section className="relative z-10 min-h-[90vh] flex flex-col items-center justify-center text-center px-6 pt-20">
                ...
                <FadeIn delay={0.8}>
                    ...
                    <p className="mt-4 text-[10px] uppercase tracking-widest text-white/30">
                        Average completion time: 15–20 minutes per day
                    </p>
                </FadeIn>
                ...
                <div className="container mx-auto px-6 max-w-5xl space-y-24">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-slate-400 leading-relaxed">
                                <p>You cannot build wealth on an unstable credit foundation. <strong className="text-white">Dorm Week™ is your structured financial reset.</strong></p>
                    ...
                    <div>
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-black uppercase tracking-tight mb-4">What You’re About to Execute</h2>
                        </div>
                    ...
                    {isScanning ? (
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-blue-200 font-mono tracking-widest uppercase">Protocol Activated • Reset Mode: ON</p>
                            </motion.div>
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-mono text-[10px] text-amber-400 uppercase tracking-[0.2em]">Dorm Week™ Student ID</p>
                                            </div>
                                        </div>
                                        {/* Status Chip */}
                        ...
                        <div className="grid md:grid-cols-2 gap-12 mb-16">
                            <div>
                                ...
                                <p className="text-slate-400 leading-relaxed mb-4">
                                    Dorm Week™ is your structured financial reset. It is designed to stabilize your profile, sharpen your strategy, and position you for higher approvals.
                                </p>
                            </div>
                            <div>
                                ...
                                <ul className="space-y-2 text-sm text-slate-300 font-mono uppercase tracking-wide">
                                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-amber-500 rounded-full" /> 01 — System Reality Check</li>
                                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-amber-500 rounded-full" /> 02 — Strategic Positioning</li>
                                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-amber-500 rounded-full" /> 03 — Optimization & Approval Readiness</li>
                                </ul>
                            </div>
                        </div>
